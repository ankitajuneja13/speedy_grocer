...
<html>
<head>
<title>Speedy Grocer-Login/Signup</title>
...
<%String attempt=request.getParameter("loginattempt");
if(attempt!=null&&attempt.equals("fail")){%>
<script type="text/javascript">
alert("Invalid Username or password!!!");
</script>

<%}else if(attempt!=null&&attempt.equals("send")){ %>
<script type="text/javascript">
alert("link is send to your Email id to change password");
</script>
<%} %>
</head>
			...
			<div class="w3_login_module">
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="loginto" method="get">
					  <input type="text" name="Username" placeholder="Username" required=" ">
					  <input type="password" name="Password" placeholder="Password" >
					  <input type="submit" value="Login" name="login">
					    <input type="submit" value="Forgot your Password?" name="login">
					</form>
				  </div>
				  <div class="form">
